...
/**
 * Servlet implementation class CoverImgUpload
 */
@WebServlet("/CoverImgUpload")
public class CoverImgUpload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		System.out.println("CoverImgUpload servlet");
		 ...
		 * */
		String image_path = "user/" + username + "/image/" + copyFileName;
